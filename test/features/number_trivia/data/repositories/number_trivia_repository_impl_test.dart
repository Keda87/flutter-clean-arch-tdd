...
import 'package:clean_arc_tdd_course/core/platform/network_info.dart';
import 'package:clean_arc_tdd_course/features/number_trivia/data/datasources/number_trivia_local_data_source.dart';
...
import 'package:clean_arc_tdd_course/features/number_trivia/data/repositories/number_trivia_repository_impl.dart';
...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline(() {
      ...
      test(
          'should cache the data locallly when the call to remote data source is success',
          () async {
        when(mockRemoteDataSource.getConcreteNumberTrivia(any))
            .thenAnswer((_) async => tNumberTriviaModel);
